...
$cmd_1 = <<<EOT
a=`systemctl status apache2 | grep active | awk '{print $2}'`;if [ \$a = "active" ]; then echo "Apache2 is active"; elif [ \$a = "inactive" ]; then echo "Apache2 is inactive"; else echo "Unknown error or package isn't installed!";fi
EOT;
